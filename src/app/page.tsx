...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#fafafa] flex items-center justify-center relative">
      <div className="flex items-center gap-4 text-slate-900 hover:text-indigo-600 transition-colors cursor-pointer group">
