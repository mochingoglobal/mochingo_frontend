...
import { QrCode, LogOut, Loader2, LayoutDashboard, Users, Briefcase, Activity, Database, CreditCard } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const navigation = [
        ...
        { name: 'ID Cards',      href: '/portal-x/id-cards',      icon: CreditCard },
        { name: 'Customer Data', href: '/portal-x/data-entry',    icon: Database },
