...
export default function AnalyticsPage() {
    ...
    const getIntensityClass = (count: number) => {
        if (count === 0) return 'bg-[#1a2133] border-mochingo-warm-oat/10 text-slate-500';
        ...
        if (ratio <= 0.75) return 'bg-mochingo-warm-oat text-mochingo-rich-black/80 border-indigo-500/60 text-mochingo-warm-oat';
        return 'bg-indigo-500 border-indigo-400 text-mochingo-warm-oat shadow-[0_0_15px_rgba(99,102,241,0.5)]';
    };
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-[rgba(242, 237, 231, 0.05)] border border-mochingo-warm-oat/10 p-6 rounded-2xl shadow-lg relative overflow-hidden group">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <h3 className="text-3xl font-bold text-mochingo-warm-oat">
            ...
            {/* Calendar View */}
            <div className="bg-[rgba(242, 237, 231, 0.05)] border border-mochingo-warm-oat/10 p-6 rounded-2xl shadow-lg">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-lg font-bold text-mochingo-warm-oat flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-4">
                        <button 
                            onClick={prevMonth}
                            className="p-2 bg-[var(--mochingo-rich-black)] hover:bg-[#1f2638] border border-white/10 rounded-lg text-slate-300 transition-colors"
                        >
                            <ChevronLeft size={18} />
                        </button>
                        <div className="text-mochingo-warm-oat font-medium min-w-[140px] text-center">
                ...
                {error ? (
                    ...
                    <div className="relative">
                        {isLoading && (
                            <div className="absolute inset-0 bg-[rgba(242, 237, 231, 0.05)]/80 backdrop-blur-[2px] z-10 flex items-center justify-center rounded-xl">
                            ...
                            {calendarDays.map((day, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isToday && (
                                            <div className="absolute top-1.5 right-1.5 w-1.5 h-1.5 bg-indigo-400 rounded-full ring-2 ring-[rgba(242, 237, 231, 0.05)]"></div>
                                        )}
                                        
                                        {/* Tooltip */}
                                        {count > 0 && (
                                            <div className="absolute -top-12 bg-slate-800 text-mochingo-warm-oat text-xs py-1.5 px-3 rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap z-30 shadow-xl border border-white/10">
                ...
                <div className="mt-8 flex items-center justify-end gap-3 text-xs text-slate-400 font-medium">
                    ...
                    <div className="flex gap-1">
                        <div className="w-5 h-5 rounded-sm bg-[#1a2133] border border-mochingo-warm-oat/10"></div>
                        ...
                        <div className="w-5 h-5 rounded-sm bg-mochingo-warm-oat text-mochingo-rich-black/80 border border-indigo-500/60"></div>
