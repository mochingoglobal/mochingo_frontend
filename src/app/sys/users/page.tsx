...
const statusColors: Record<string, { bg: string; color: string; border: string }> = {
    ...
    disabled:   { bg: 'rgba(239,68,68,0.10)',   color: '#ef4444', border: 'rgba(239,68,68,0.20)'   },
};
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                            ...
                            <div style={{
                                ...
                                <span style={{
                                    ...
                                    <QrCode size={13} /> {data?.qr_count} QR{(data?.qr_count ?? 0) !== 1 ? 's' : ''}
                                </span>
                            </div>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                                {[
                                    { icon: <Phone size={13} />,    label: 'Mobile',   value: u.mobile_number },
                                    { icon: <MapPin size={13} />,   label: 'Place',    value: u.place },
                                    { icon: <Briefcase size={13} />,label: 'Business', value: u.business },
                                    { icon: <Calendar size={13} />, label: 'Joined',   value: formatDateTime(u.created_at) },
                                    ...
                                    <div key={label} style={{
                                        ...
                                        <p style={{ fontSize: 11, fontWeight: 600, color: '#475569', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 5, display: 'flex', alignItems: 'center', gap: 5 }}>
                                            {icon} {label}
                                        </p>
                            ...
                            {/* QR list */}
                            <div>
                                <p style={{ fontSize: 12, fontWeight: 700, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 10, display: 'flex', alignItems: 'center', gap: 6 }}>
                                    <QrCode size={13} /> QR Codes ({qrs.length})
                                </p>
                                                    ...
                                                    <div style={{ flex: 1, minWidth: 0 }}>
                                                        ...
                                                        {qr.assigned_at && (
                                                            <p style={{ fontSize: 12, color: '#475569', marginTop: 2 }}>
                                                                Assigned {formatDateTime(qr.assigned_at)}
                                                            </p>
                                                        )}
                                                    </div>
        ...
        <>
            ...
            <div className="flex flex-col max-w-full">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="card p-4 sm:p-5">
                        <p style={{ fontSize: 12, fontWeight: 600, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 8 }}>Total QRs Assigned</p>
