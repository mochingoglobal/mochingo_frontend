                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', gap: 8 }}>
                                <input className="input" value={data.qr_url} readOnly style={{ opacity: 0.7 }} />
                                <button className="btn btn-outline" onClick={() => { navigator.clipboard.writeText(data.qr_url); alert('Copied!'); }}><Copy size={14}/></button>
                                <a href={data.qr_url} target="_blank" className="btn btn-outline"><ExternalLink size={14}/></a>
                            </div>
                        </div>
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <input className="input" style={{ paddingLeft: 36 }} value={manualUrl} onChange={e => setManualUrl(e.target.value)} placeholder="https://" />
                            </div>
                        </div>
                ...
                <div className="card" style={{ padding: 24 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                        ...
                        <button 
                            ...
                            style={{ width: '100%' }}
                            onClick={() => downloadSingleDynamicQRPDF(data.qr_url, data.label)}
                        >
