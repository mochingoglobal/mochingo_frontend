...
import { 
    ...
    Loader2, Link as LinkIcon, ImageIcon, X 
} from 'lucide-react';
                                    ...
                                    <tr 
                                        ...
                                        onClick={() => {
                                            if (row.qr_count > 1) {
                                                ...
                                                // If it's a single QR group, navigate to single view
                                                router.push(`/admin/qr-management/dynamic/batch/${row.batch_id}`); // Batch view handles size=1 too, or we can fetch id.
                                            }
                                        }}
                                    >
                                        <td>
...
export default function QRManagementPage() {
    ...
    return (
        <div className="flex flex-col max-w-full">
            ...
            <div className="inline-flex bg-white/5 p-1 rounded-lg mb-6 gap-1 self-start">
                <button
                    ...
                    style={{
                        ...
                        background: tab === 'custom' ? 'rgba(99,102,241,0.15)' : 'transparent',
                        color: tab === 'custom' ? '#818cf8' : '#94a3b8',
                    }}
                >
                    Custom QR
                </button>
                <button
                    ...
                    style={{
                        padding: '6px 16px', borderRadius: 6, fontSize: 14, fontWeight: 500, cursor: 'pointer', border: 'none',
                        background: tab === 'dynamic' ? 'rgba(99,102,241,0.15)' : 'transparent',
                        color: tab === 'dynamic' ? '#818cf8' : '#94a3b8',
                    }}
                >
                    Dynamic QR
                </button>
            ...
            {tab === 'custom' ? <CustomQRTab /> : <DynamicQRTab />}
        </div>
    );
}
